...
class GameOfLifeGUI:
    ...
    def left_click(self, event):
        ...
        with self.lock:
            if (cell_x, cell_y) in self.cells:
                ...
                rect = self.canvas.create_rectangle(cell_x * CELL_SIZE, cell_y * CELL_SIZE, (cell_x + 1) * CELL_SIZE, (cell_y + 1) * CELL_SIZE, fill="black", tags="cell")
    ...
    def draw_cell(self, cell):
        ...
        if cell not in self.cells:
            self.cells.add(cell)
            rect = self.canvas.create_rectangle(x * CELL_SIZE, y * CELL_SIZE, (x + 1) * CELL_SIZE, (y + 1) * CELL_SIZE, fill="black", tags="cell")
